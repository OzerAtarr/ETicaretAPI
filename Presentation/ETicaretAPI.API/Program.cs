using ETicaretAPI.API.Configrations.ColumnWriters;
...
builder.Services.AdddSignalRServices();
...
Logger log = new LoggerConfiguration()
    ...
    columnOptions: new Dictionary<string, ColumnWriterBase>
    {
        ...
        {"exception", new LogEventSerializedColumnWriter() },
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer("Admin", options =>
{
    options.TokenValidationParameters = new()
    {
        ...
        NameClaimType = ClaimTypes.Name //JWT üzerinde Name claim ne karþýlýk gelen deðeri User.IdentityçName propertysinden elde edebiliriz.
    };
});
